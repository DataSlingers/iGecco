function [U_output,Z_output,THETA_output] = igecco_plus_3type_ARP(X1,X2,X3,w,lambda1_vec,lambda2_vec,lambda3_vec,target_K)
%%% Use Algorithmic Regularization to solve a sequence of gamma
%%% We use different # of iterations for one gamma for different purposes
%%% fast: we only want cluster assignments
%%% ARP:  we want accurate feature selection
%%% full: we want accurate U value for adaptive iGecco+ weights
%%% use different versions to save computation
%%% Take step size t = 1.1 to save stoage
